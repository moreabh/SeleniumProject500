...
//	---------------------------------------------------PasswordField Start ---------------------------------------------------)
		...
		FileHandler.copy(srcScreenshot, new File(System.getProperty("user.dir")+"\\Screenshot\\registerPageActualAlignment.png"));
		
		assertFalse(CommonUtils.compareTwoScreenshots(System.getProperty("user.dir")+"\\Screenshot\\registerPageActualAlignment.png", System.getProperty("user.dir")+"\\Screenshot\\registerPageExpectedAlignment.png"));
